...
async function run() {
  ...
  let allMatches = [];
  while(true) {
    const url = `https://www.ksi.is/leikir-felaga/felagslid/?club=2193&dateFrom=2026-01-01&dateTo=2026-12-31&page=${page}`;
  ...
  console.log(`Fetched ${allMatches.length} total matches for club 2193`);
