...
export default function Fotbolti({ onOpenTickets }) {
  ...
  const dataKarla = {
    ...
    // Using generic Unsplash portraits until you get the real football headshots
    players: [
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 py-6 px-8 flex flex-col justify-between relative overflow-hidden h-[180px]">
            {loading && (
              <div className="absolute inset-0 bg-white/90 backdrop-blur-sm z-10 flex flex-col items-center justify-center">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#1c2c6c]">Sæki KSÍ Gögn...</span>
              </div>
            )}
