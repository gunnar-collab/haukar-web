...
export default function Barnastarf() {
  ...
  return (
    <main className="w-full bg-white min-h-screen pt-10 md:pt-16 pb-20 font-sans">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 py-24 px-6 text-center relative overflow-hidden">
        {/* Floating Background Icons */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-[0.03]">
          <span className="material-symbols-outlined absolute top-10 left-10 text-[100px] animate-[bounce_8s_infinite]">sports_soccer</span>
          <span className="material-symbols-outlined absolute bottom-10 right-20 text-[120px] animate-[pulse_6s_infinite]">sports_basketball</span>
          <span className="material-symbols-outlined absolute top-20 right-10 text-[80px] animate-[bounce_10s_infinite_reverse]">sports_handball</span>
          <span className="material-symbols-outlined absolute bottom-20 left-20 text-[90px] animate-[pulse_7s_infinite]">toys</span>
        </div>

        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
          <div className="w-20 h-20 rounded-[2rem] bg-white shadow-xl flex items-center justify-center mb-6 transform -rotate-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter text-[#1c2c6c] uppercase mb-6 drop-shadow-sm">
            Barnastarf
          </h1>
          <p className="text-gray-500 font-medium text-lg md:text-xl leading-relaxed max-w-2xl text-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 -mt-10 relative z-20">
